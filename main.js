...
const dayCardTemplate = document.querySelector("#day__card-template");
...
const HOUR_FORMATER = new Intl.DateTimeFormat(undefined, {
  hour: "numeric",
  minute: "numeric",
  hour12: false,
});
const hourlySection = document.querySelector("[data-hour-section");
const hourRowTemplate = document.querySelector("#hour__row-template");
